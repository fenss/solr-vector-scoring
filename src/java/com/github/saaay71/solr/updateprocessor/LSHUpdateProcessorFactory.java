...
public class LSHUpdateProcessorFactory extends UpdateRequestProcessorFactory {
    ...
    public String lshHashFieldName;
    public String lshBinaryFieldName;
    ...
    public void init(NamedList args) {
        ...
        fieldName = (String) args.get("field");
        lshHashFieldName = (String) args.get("lsh_hash");
        lshBinaryFieldName = (String) args.get("lsh_binary");
    }

    public UpdateRequestProcessor getInstance(SolrQueryRequest req, SolrQueryResponse rsp, UpdateRequestProcessor next) {
        return new LSHUpdateProcessor(req.getSchema(), fieldName, lshHashFieldName, lshBinaryFieldName, stages, buckets, dimensions, seed, next);
    }
...
class LSHUpdateProcessor extends UpdateRequestProcessor {
    ...
    public LSHUpdateProcessor(IndexSchema schema, String fieldName, String lshHashFieldName, String lshBinaryFieldName, int stages, int buckets, int dimensions, Long seed, UpdateRequestProcessor next) {
        super(next);
        ...
        this.lshHashFieldName = lshHashFieldName;
        this.lshBinaryFieldName = lshBinaryFieldName;
    }
    ...
    public void processAdd(AddUpdateCommand cmd) throws IOException {
        ...
        if (cmdDoc.containsKey(field.getName())) {
            ...
            // cmdDoc.setField(LSHUpdateProcessorFactory.DEFAULT_BINARY_FIELD_NAME, VectorUtils.encode(vectorStr, vecType).bytes);
            cmdDoc.setField(this.lshBinaryFieldName, VectorUtils.encode(vectorStr, vecType).bytes);
            ...
            cmdDoc.setField(this.lshHashFieldName, hashStringValues);
        }
