    ...
    public QParser createParser(String qstr, SolrParams localParams, SolrParams params, SolrQueryRequest req) {
        return new QParser(qstr, localParams, params, req) {
            ...
            public Query parse() throws SyntaxError {
                ...
                String lshHashFieldName = localParams.get("lsh_hash");
                boolean cosine = localParams.getBool("cosine", true);
                String chainName = localParams.get("chain");

                if (field == null) {
                    throw new SolrException(SolrException.ErrorCode.BAD_REQUEST, "Not specifyed 'f'");
                }

                if (vector == null) {
                    throw new SolrException(SolrException.ErrorCode.BAD_REQUEST, "Missing input vector");
                }
            ...
            private String computeLSHQueryString(String vector, String[] vectorArray, String lshHashFieldName, String chainName) {
                // String reqChain = getUpdateChainName(req);
                String reqChain = chainName;
                ...
                Stream<String> queryStringStream = LSHUtils.getLSHStringStream(intHash)
                        .map(x -> "(" + lshHashFieldName + ":\"" + x + "\")^=" + stagesScorePercentage);
